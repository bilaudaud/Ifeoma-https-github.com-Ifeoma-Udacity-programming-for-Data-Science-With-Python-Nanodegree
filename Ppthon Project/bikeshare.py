...
def get_drills():
    """
    Asks specific city, month, and day to analyze.

    Returns:
        String: city - name of the city to analyze
        String: month - name of the month to drill by, or "all" to apply no month filter
        String: day - name of the day of week to filter by, or "all" to apply no day filter
    """
    print('\nHello USer! Let\'s analyze some US bikeshare data!')
